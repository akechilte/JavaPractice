...
public class LeetCode4 {
    ...
    public static double findMedianSortedArrays(int[] nums1, int[] nums2) {
        if (nums1.length == 0 || nums1.length != nums2.length) throw new IllegalArgumentException();
        return median(Subarray.fromArray(nums1), Subarray.fromArray(nums2));
    }
